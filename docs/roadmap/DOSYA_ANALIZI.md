...
Son Güncelleme: 2025-10-28 20:20:29 (Otomatik)
Commit: N/A
...
| Toplam Dosya | 68 |
| Toplam Satır | 18,748 |
| Ortalama Dosya Boyutu | 276 satır |
...
| 3 | `BackendStructureTab.tsx` | 568 | `Frontend/src/pages/admin/reports/tabs/BackendStructureTab.tsx` | Component'lere/modüllere bölünmeli |
| 4 | `ProjectDataPage.tsx` | 543 | `Frontend/src/pages/projects/data/ProjectDataPage.tsx` | Component'lere/modüllere bölünmeli |
| 5 | `FrontendStructureTab.tsx` | 527 | `Frontend/src/pages/admin/reports/tabs/FrontendStructureTab.tsx` | Component'lere/modüllere bölünmeli |
| 6 | `ArchitectureComplianceTab.tsx` | 511 | `Frontend/src/pages/admin/reports/tabs/ArchitectureComplianceTab.tsx` | Component'lere/modüllere bölünmeli |
| 7 | `AdLinkModal.tsx` | 496 | `Frontend/src/pages/cio/dashboard/components/AdLinkModal.tsx` | Component'lere/modüllere bölünmeli |
| 8 | `EndpointComplianceTab.tsx` | 472 | `Frontend/src/pages/admin/reports/tabs/EndpointComplianceTab.tsx` | Component'lere/modüllere bölünmeli |
...
| Kategori | Dosya Sayısı | Yüzde | Durum |
|----------|--------------|-------|-------|
| ✅ Olumlu (0-300) | 62 | 77% | İyi |
| ⚠️ Dikkat (301-450) | 6 | 7% | Gözden geçir |
| 🔴 Bölünmeli (451-700) | 2 | 2% | Refactor gerekli |
...
| # | Dosya | Satır | Yol | Öneri |
|---|-------|-------|-----|-------|
| 1 | `analyze-files.js` | 593 | `Backend/src/scripts/analyze-files.js` | Modüllere bölünmeli |
...
| 3 | `data.controller.js` | 360 | `Backend/src/modules/data/data.controller.js` | İzlenmeli |
...
| 8 | `data.routes.js` | 36 | `Backend/src/modules/data/data.routes.js` | ✅ İyi |
...
| 43 | `server.js` | 115 | `Backend/src/app/server.js` | ✅ İyi |
| 44 | `auth.model.js` | 116 | `Backend/src/modules/auth/auth.model.js` | ✅ İyi |
| 45 | `auth.js` | 121 | `Backend/src/shared/middleware/auth.js` | ✅ İyi |
| 46 | `001_initial_schema.sql` | 124 | `Backend/migrations/001_initial_schema.sql` | ✅ İyi |
| 47 | `endpoint-compliance.service.js` | 133 | `Backend/src/modules/admin/services/compliance/endpoint-compliance.service.js` | ✅ İyi |
| 48 | `migration-report.service.js` | 149 | `Backend/src/modules/admin/services/migrations/migration-report.service.js` | ✅ İyi |
| 49 | `apiKeyGenerator.js` | 155 | `Backend/src/modules/api-keys/utils/apiKeyGenerator.js` | ✅ İyi |
| 50 | `phase-progress.service.js` | 162 | `Backend/src/modules/admin/services/compliance/phase-progress.service.js` | ✅ İyi |
| 51 | `table-comparison.service.js` | 162 | `Backend/src/modules/admin/services/migrations/table-comparison.service.js` | ✅ İyi |
| 52 | `tables-info.service.js` | 185 | `Backend/src/modules/admin/services/database/tables-info.service.js` | ✅ İyi |
| 53 | `master-admin-api-keys.service.js` | 201 | `Backend/src/modules/api-keys/services/master-admin-api-keys.service.js` | ✅ İyi |
| 54 | `project.controller.js` | 209 | `Backend/src/modules/projects/project.controller.js` | ✅ İyi |
...
| 57 | `user-api-keys.service.js` | 252 | `Backend/src/modules/api-keys/services/user-api-keys.service.js` | ✅ İyi |
| 58 | `wrong-progress.service.js` | 255 | `Backend/src/modules/admin/services/compliance/wrong-progress.service.js` | ✅ İyi |
| 59 | `api-keys.controller.js` | 256 | `Backend/src/modules/api-keys/api-keys.controller.js` | ✅ İyi |
| 60 | `migrate.js` | 276 | `Backend/src/scripts/migrate.js` | ✅ İyi |
| 61 | `admin.controller.js` | 277 | `Backend/src/modules/admin/admin.controller.js` | ✅ İyi |
| 62 | `schemaInspector.js` | 295 | `Backend/src/core/database/schemaInspector.js` | ✅ İyi |
...
3. **🔴 analyze-files.js (593 satır)** - Backend
4. **🔴 BackendStructureTab.tsx (568 satır)** - Frontend
5. **🔴 architecture-compliance.service.js (558 satır)** - Backend
6. **🔴 ProjectDataPage.tsx (543 satır)** - Frontend
7. **🔴 FrontendStructureTab.tsx (527 satır)** - Frontend
8. **🔴 ArchitectureComplianceTab.tsx (511 satır)** - Frontend
9. **🔴 AdLinkModal.tsx (496 satır)** - Frontend
10. **🔴 EndpointComplianceTab.tsx (472 satır)** - Frontend
...
| **Ortalama (Frontend)** | 276 satır | <100 | ⚠️ 0% | Yüksek |
